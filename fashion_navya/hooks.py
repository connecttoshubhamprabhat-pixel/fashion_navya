...
doc_events = {
    ...
    "Item":{
           "on_update":["fashion_navya.utils.doc_event.item.custom_descrip"],
            ...
            "before_save":["fashion_navya.utils.doc_event.test.check_subconrcat","fashion_navya.utils.doc_event.item.make_kit_item_parent_save","fashion_navya.utils.doc_event.item.make_add_kt","fashion_navya.utils.doc_event.item.fetched_warehouse_qty_w","fashion_navya.utils.doc_event.item.renamedoc"],
