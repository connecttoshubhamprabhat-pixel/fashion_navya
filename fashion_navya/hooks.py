...
doc_events = {
	"Stock Entry": {
		        "before_save":["fashion_navya.utils.doc_event.stock.count_qty_noc","fashion_navya.utils.doc_event.stock.check_work_flow","fashion_navya.utils.doc_event.stock.warehouse_check_se"],
