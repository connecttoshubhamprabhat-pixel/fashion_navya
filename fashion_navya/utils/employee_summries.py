	...
	return [
		...
		{"label": _("Working Hours"), "fieldtype": "Float", "fieldname": "total_hours", "width": 150},
		{
			...
			"width": 150,
                ...
                {"label": _("Billing Amount"), "fieldtype": "Currency", "fieldname": "amount", "width": 150,"hidden":1},
	]
...
def get_data(filters):
	...
	for ts, ts_details in timesheet_details.items():
		...
		for row in ts_details:
			...
			tsdoc=frappe.get_doc("Timesheet",ts)
			...
			data.append(
				{
					...
					"timesheet": ts,
					"dfs":tsdoc.developer_forum,
					"tname":tsdoc.subject_developer,
