...
def throw_error_se(doc,method):
    ...
    if doc.stock_entry_type in ['Material Receipt','Material Issue']:
        if user not in ["kalim@navyacustom.com","samap@navyacustom.com","sujeets@navyacustom.com","faeemm@navyacustom.com","kundan@navyacustom.com","Administrator","pawasthy11@gmail.com","amita@navya.biz","erpsupport@uttamenergy.com"]:
